...
class parameter_generator:
    ...
    def new_parameters(self, index):
        ...
        pm.x = 0*cts.R_sun
        pm.b = np.linspace(0.1, 10, self.n_points)[index]*cts.R_sun
...
def slave_work(pm, npoints=1000):

    # Initialize the parameters generator class
    param_gen = parameter_generator(pm, n_points=npoints)
