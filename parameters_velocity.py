...
zf = 30200.0*1e5   # geometrical height of the slab [cm] (around 3 arcsec)
...
ray_out = [[1., 90.]]             # List of mu,phi for emergent radiation directions
...
velocity = [0, 0, 2.99e4]   # Velocity of the slab [cm/s]
vel = (velocity[0]**2 + velocity[1]**2 + velocity[2]**2)**0.5
...
dir = f'output_vel_anis_ray_{ray_out[0][0]}_{ray_out[0][1]}__B_{B}_v_{vel}/'
del time, vel